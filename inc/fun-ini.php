...
date_default_timezone_set('America/America/Mexico_City');
    ...
    function menuEmergenteJSON($codigo,$tCodSeccion,$arrEstados = false)
    {
        ...
        //$funcion = str_replace('codigo',$codigo,$rBoton{'tFuncion'});
            ...
            $disable = ($arrEstados && $arrEstados[$rBoton{'ePosicion'}]==false) ? 'disabled="disabled"' : '';
        
        $mostrar = ($bDelete) ? '' : 'style="display:none;"';
            
            $tHTML .= '<a class="dropdown-item" '.$disable.' 
