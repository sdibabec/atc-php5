...
<div class="row">
<!--calendario-->
    <div class="col-lg-12   au-card--no-pad m-b-40" style="position: relative; z-index: 9999;">
        <center>
        ...
        <form id="Datos" name="Datos" method="post" action="<?=$_SERVER['REQUEST_URI']?>">
            <div class="form-group col-md-6">
                <div class="input-group date">
                    <input type="text" class="form-control" name="fhFechaConsulta" id="fhFechaConsulta" value="<?=date('d/m/Y');?>" data-date-format="mm/dd/yyyy" style="position: relative; z-index: 1;">
                    <div class="btn btn-primary" onclick="consultarFecha()">
