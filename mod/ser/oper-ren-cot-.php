...
<div class="row">
    ...
    <form id="datos" name="datos" action="<?=$_SERVER['REQUEST_URI']?>" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" name="eAccion" id="eAccion">
              ...
              <label>Cliente<input type="text" class="form-control au-input au-input--xl" name="tCliente" id="tCliente" placeholder="Cliente" autocomplete="off" onkeyup="buscarClientes()"></label>
               <div class="resultClient" id="resultadoCliente"></div>                         
           </div>
